...
import 'cancel_reg_enter_emp_num2_model.dart';
export 'cancel_reg_enter_emp_num2_model.dart';

class CancelRegEnterEmpNum2Widget extends StatefulWidget {
  const CancelRegEnterEmpNum2Widget({super.key});

  @override
  State<CancelRegEnterEmpNum2Widget> createState() =>
      _CancelRegEnterEmpNum2WidgetState();
}

class _CancelRegEnterEmpNum2WidgetState
    extends State<CancelRegEnterEmpNum2Widget> with TickerProviderStateMixin {
  late CancelRegEnterEmpNum2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CancelRegEnterEmpNum2Model());
