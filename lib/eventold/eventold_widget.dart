...
class EventoldWidget extends StatefulWidget {
  const EventoldWidget({super.key});

  @override
  State<EventoldWidget> createState() => _EventoldWidgetState();
}

class _EventoldWidgetState extends State<EventoldWidget>
    with TickerProviderStateMixin {
  late EventoldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventoldModel());
