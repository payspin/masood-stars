                                  ...
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if ((_model.apiResultz1r?.succeeded ??
                                            true)) {
                                          await currentUserReference!
                                              .update(createUsersRecordData(
                                            sendEmail: true,
