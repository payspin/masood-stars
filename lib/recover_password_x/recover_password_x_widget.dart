...
class RecoverPasswordXWidget extends StatefulWidget {
  const RecoverPasswordXWidget({super.key});

  @override
  State<RecoverPasswordXWidget> createState() => _RecoverPasswordXWidgetState();
}

class _RecoverPasswordXWidgetState extends State<RecoverPasswordXWidget> {
  late RecoverPasswordXModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecoverPasswordXModel());
