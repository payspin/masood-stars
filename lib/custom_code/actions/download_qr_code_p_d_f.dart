...
// Function to download PDF from the provided URL
Future<List<dynamic>> downloadQrCodePDF(String pdfUrl) async {
  ...
  // The PDF data (bytes) from the response
  final pdfBytes = response.bodyBytes;

  // For Web platform
  if (kIsWeb) {
    // Create a Blob from the PDF bytes and trigger a download via the browser
  ...
  if (!kIsWeb) {
    ...
    // Create a new file and write the PDF bytes to it
